...
\cite[Lem.~9.2]{rhocomb3}, written as a formula. The counting of
...
\begin{proof}
\cite[Lem.~9.2]{rhocomb3}: every rule but that for $\ev$ strictly decreases the
