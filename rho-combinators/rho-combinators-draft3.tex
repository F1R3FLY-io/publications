...
open a name that arrives at runtime but never build one. A name-closure
lemma turns this into the bottom edge of an expressiveness lattice over
subsets of the atom set, developed in \S\ref{sec:lattice}. A small family of constructors closes
