...
\begin{obligation}[Unitarity and extraction]\label{ob:unitary}
Theorem~\ref{thm:scattering} makes a clause a matrix; nothing so far makes it
unitary. Which graded clauses give isometries, and what syntactic condition
corresponds to uniformisation, determines whether a graded program can be
extracted to a circuit rather than merely simulated.
\end{obligation}
