...
Maturity is the middle position, not the far one. An organism that could not
forget would be as unviable as one that forgot for free, and every model in this
survey built to resemble a living thing sits at priced discarding rather than at
prohibited. \S\ref{sec:threshold} returns to this, because the gap between the
middle position and the far one is exactly why neither of the two traditions
