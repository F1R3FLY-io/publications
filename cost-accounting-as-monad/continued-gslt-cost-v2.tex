...
that it does not introduce \emph{ambient authority}, the antithesis of an
...
thus, in its static aspect, spatial.
...
proof}: a derivation in a linear logic witnessing that the available
