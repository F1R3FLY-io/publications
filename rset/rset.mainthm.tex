...
$\mathrm{Comprehension}$ over finite domains give finite separation; and the
equations of the formal theory are exactly those forcing extensionality, that red
sets with the same members are equal. The $\Sym(\Atoms)$-action and the
