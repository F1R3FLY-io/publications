...
parameters we find. We do treat reproduction (\S\ref{sec:repro}), but we do not treat inheritance of
...
//
// The guard enforces Prop. 58: a parent may not endow below the outlay its
