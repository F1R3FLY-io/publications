...
The calculus is $\rhoplus$,\footnote{We write \emph{rho}, never $\rho$. The name is an acronym and a
pun at once: it abbreviates the \emph{reflective higher order} calculus, and dropping the periods
from r.h.o.\ gives the English transliteration of the Greek letter following $\pi$ --- which is
where this calculus stands relative to the $\pi$-calculus.} core rholang with mixed summation
\cite[Def.~9]{Geometry}: summands may
