...
One chapter is not a rung: the last of them spends the ladder rather than
extending it, returning to the learner of Part~\ref{part:choice} to say
what holding a level costs in a world of this kind.
...
conversion is arbitrage-free
  ...
  & \ref{sec:cost} \\
the decoration is internalized
...
Chapter~\ref{sec:synthesis} collects the ladder into one picture.
Chapter~\ref{ch:homeo-ent} then spends it on the previous part: a learner
holding a setpoint against friction is paying a bill in the currency
Chapter~\ref{sec:cost} priced, and the chapter says what the bill comes
to and who it is charged to.
