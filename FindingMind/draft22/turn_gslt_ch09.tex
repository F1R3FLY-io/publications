\chapter{Conversion, Enzymes, and the Virtual Token}
\label{ch:vtok}
% ===================================================================
...
\emph{enzymes}, presented with both orientations; and
$r : E \to \Rpos$ is a \emph{rate} satisfying
\[
  r(a \to b) \cdot r(b \to a) = 1 .
\]
An enzyme $a \to b$ is read operationally: one unit of the $a$-token is
...
The paradigm enzyme is a persistent exchange process --- a contract
...
terms.
An enzyme is a computation, and it can be eaten like any other.
...
$\nu : \Tok \to \Rpos$ with
\[
  r(a \to b) = \frac{\nu(a)}{\nu(b)} \qquad \text{for every enzyme } a \to b .
\]
...
along $\ast$-compatible enzymes, leaving as residual freedom a
...
flavors, as one prices in dollars --- fixes the gauge at a vertex.
