...
Chapter~\ref{ch:suffer} gave the learner a goal it can state about
itself, and a reading of its own distance from that goal.
It did not say what the goal costs, and it could not: the currency had
not been built yet.

This part has now built it, and this chapter spends it.
Homeostasis is not free, and it is not free for a reason that has been
sitting in this part since the conservation chapter: a cost-accounted
theory is frictionful by construction, and a learner holding a level
against friction is paying a bill in exactly the currency
Chapter~\ref{sec:cost} priced.
What follows is short, because the work was done in the chapters above.
Its job is to collect it, and to hand the result back to a learner who
was given a goal several parts ago and no way to pay for it.
...
Proposition~\ref{ent:prop:self-charge} is the reason
Chapter~\ref{ch:suffer} could not simply assert that internalizing is
better.
...
That leaves an obligation the Turn does not discharge.
...
forward only this: the learner of Chapter~\ref{ch:suffer} has been given,
for the first time, information of a shape that makes a choice
