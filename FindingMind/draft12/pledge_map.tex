...
It is the last thing in the Pledge, and it is the only chapter in
the book that is about the book.
...
\item Theorem~\ref{thm:compact-consensus}, on consensus under
      compactness, is stated as a theorem and its proof does not
      work as given.
      The Conclusion calls it the sharpest result in its part,
      which makes this the most consequential gap in the book.
