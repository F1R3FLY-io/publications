...
stage, and consciousness as a coordinate: the strength of choice an
agent can afford, which is a position in a lattice and not a rung on a
ladder.
Every agent occupies one.
The two quantities vary independently and are linked by cycles that can
run in either direction --- an agent that cannot afford to resolve its
world predicts worse, and an agent that predicts worse can afford
less.
