...
causal depth.
The decoration gives a sum over paths, and in its tropical
instance a principle of least action.
The conversion structure gives conservation as a theorem with a
hypothesis, a second law when that hypothesis fails, and a lower
bound on how much history must be retained for energy to remain a
state function.
The extended modal operators internalize the decoration as a
logical fact.
These are constructions and theorems, not analogies --- and where
what remains is an analogy, chiefly the identification of the
conserved charge with a generator of time evolution, we have said
so.
They are stated precisely enough to be wrong.
