...
bias. We return to this in \S\ref{sci:sec:lattice}, and it is the reason the note's central objects are
...
\subsection{A canonical section}\label{sci:S15.2}
...
\subsection{The morphisms must be logic-preserving}\label{sci:S15.3}
...
The assignment of Proposition~\ref{sci:prop:section} is not functorial on $\mathbf{GSLT}$-morphisms. It requires
