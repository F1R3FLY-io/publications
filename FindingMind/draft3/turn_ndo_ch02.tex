...
\S\ref{sec:fibration} the stratification was \emph{external}: a fibration over a category of models,
...
The fibration of \S\ref{sec:fibration} is a map, and we should not mistake it for the
