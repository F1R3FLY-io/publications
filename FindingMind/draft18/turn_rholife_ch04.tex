...
chapter supplies.
There is a second, and Chapter~\ref{ch:apr} supplies it: close where no
internal cut carries observable choice --- draw the line around the
regions that are determinate, in the sense of
Definition~\ref{ndo:def:aperture}.
