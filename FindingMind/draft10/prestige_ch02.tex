...
The Turn took it apart.
Priest's Prestige would now bring it back and say nothing.
...
It financed a good deal of Chapter~\ref{ch:kant}.
The reason an agent here can do from inside what Kant had to do by
gesturing outward at his readers is that the agent's hypotheses are
terms of the same substrate the hypotheses are about.
Reflection is not a philosophical posture but a feature of the
calculus.
That is right, and it is right within the scope.

And it financed the pivot of Section~\ref{sec:kant-affordable}: the
noumenal as a budget constraint rather than a categorial
prohibition.
Hennessy--Milner adequacy positively characterizes the
bisimulation class, so what is out of reach is out of reach for
want of funds rather than for want of concepts.
