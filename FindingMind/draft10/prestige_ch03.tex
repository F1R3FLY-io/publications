...
What a budget buys, which is the third appearance in this book of
the pivot of Section~\ref{sec:kant-affordable}
...
Section~\ref{sec:kant-affordable} argued that Kant's thing-in-itself
survives translation into computation as an economic fact rather
than a logical one, and gave two instances.
Modal depth: Hennessy--Milner adequacy characterizes the
bisimulation class positively, and says nothing about whether the
separating formula can be afforded.
Counting: Chapter~\ref{sec:scope-manufacture} shows that a learner
does not fail to see the distinctions it cannot afford, it fails to
see that they are there, and reports a world with fewer kinds in it
than the world has.
...
Section~\ref{sec:kant-affordable} made on the noumenal, applied one
level down to the question of what counts as a symbol at all --- and
it has the same consequence, which is that a wall turns into a
