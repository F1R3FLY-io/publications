...
A reader who has come through Part~\ref{part:ecology} has met this
chapter's content already, in the form of a scientist that could learn
nothing about a specimen without spending a token on it.
It is stated again here, and abstractly, for a reason worth giving
plainly: the population argument that follows does not need a budget, and
stating the isolation principle without one makes visible how little the
argument actually assumes.
What was there an economic predicament is here a structural theorem.
Nothing below depends on the learner being mortal, or on tokens existing
at all.
