...
That argument has a precedent this part gives a mechanism: metering caps
a defector, which is why mortality is selected --- not in spite of
bounding lives but because a bounded life is the precondition for a
stable individual at all.
The part closes by observing that such a learner holds information of a
shape that makes a choice meaningful, and hands that observation on
unspent.
